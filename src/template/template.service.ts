...
<body>
    <center>
        <h2>${nome}</h2>
        <p>Messaggio: ${testotemp}</p>
        <div class='slideshow-container'>
            <img src='https://www.marconisoftware.com/assets/01.png' style='width: 100%' />
        </div>
    </center>
</body>
</html>
...
<body>
    <center>
        ...
        <p>Messaggio: ${testotemp}</p>
        <div class='slideshow-container'>
            <img src='https://www.marconisoftware.com/assets/01.png' style='width: 100%;height: 100%' />
        </div>
    </center>
</body>
</html>
`;
      ...
      <body style="background-color:#9dc3e7;">
        <body>
          <img src="image3.png" style="width: 100%" />
          <p></p>
          <div class="row">
            <div class="column">
              <p><img src="image.png" style="width: 50%" /></p>
              <b>${nome}</b>
            </div>
            <div class="column">
              <p>${testotemp}</p>
              <p><img src="image2.png" style="width: 50%" /></p>
            </div>
          </div>
          <div style="position: absolute; top: 80%; left: 0; bottom: 0; right: 0; width: auto; height: auto; max-width: 100%;max-height: 100%; margin: auto auto 0;">
            <img src="image3.png" style="width: 100%" />
          </div>
        </body>
      </html>`;
